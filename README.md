...
- Voted, weighted-random game events with a slot-machine selection animation — events are pluggable via the [API](docs/api.md#custom-game-events), with Lava, Knockback, Border and Meteors provided by the bundled [events addon](examples/gourpillars-events-addon)
