    ...
    fun displayInventory(player: Player) {
        ...
        val glassPane =
            ItemStack(Material.GRAY_STAINED_GLASS_PANE).apply {
                itemMeta = itemMeta?.apply { displayName(MessageData.GUI_ITEM_FILLER_NAME) }
            }
